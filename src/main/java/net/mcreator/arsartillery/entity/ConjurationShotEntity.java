...
public class ConjurationShotEntity extends AbstractArrow implements ItemSupplier {
	...
	public ConjurationShotEntity(EntityType<? extends ConjurationShotEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public ConjurationShotEntity(EntityType<? extends ConjurationShotEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static ConjurationShotEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ConjurationShotEntity entityarrow = new ConjurationShotEntity(ArsArtilleryModEntities.CONJURATION_SHOT.get(), entity, world, null);
	...
	public static ConjurationShotEntity shoot(LivingEntity entity, LivingEntity target) {
		ConjurationShotEntity entityarrow = new ConjurationShotEntity(ArsArtilleryModEntities.CONJURATION_SHOT.get(), entity, entity.level(), null);
