...
public class EarthshotEntity extends AbstractArrow implements ItemSupplier {
	...
	public EarthshotEntity(EntityType<? extends EarthshotEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public EarthshotEntity(EntityType<? extends EarthshotEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static EarthshotEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EarthshotEntity entityarrow = new EarthshotEntity(ArsArtilleryModEntities.EARTHSHOT.get(), entity, world, null);
	...
	public static EarthshotEntity shoot(LivingEntity entity, LivingEntity target) {
		EarthshotEntity entityarrow = new EarthshotEntity(ArsArtilleryModEntities.EARTHSHOT.get(), entity, entity.level(), null);
