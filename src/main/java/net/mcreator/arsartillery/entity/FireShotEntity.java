...
public class FireShotEntity extends AbstractArrow implements ItemSupplier {
	...
	public FireShotEntity(EntityType<? extends FireShotEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public FireShotEntity(EntityType<? extends FireShotEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static FireShotEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		FireShotEntity entityarrow = new FireShotEntity(ArsArtilleryModEntities.FIRE_SHOT.get(), entity, world, null);
	...
	public static FireShotEntity shoot(LivingEntity entity, LivingEntity target) {
		FireShotEntity entityarrow = new FireShotEntity(ArsArtilleryModEntities.FIRE_SHOT.get(), entity, entity.level(), null);
