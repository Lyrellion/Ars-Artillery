...
public class EarthTurret3Renderer extends GeoEntityRenderer<EarthTurret3Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, EarthTurret3Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
