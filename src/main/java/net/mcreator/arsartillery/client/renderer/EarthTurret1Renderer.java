...
public class EarthTurret1Renderer extends GeoEntityRenderer<EarthTurret1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, EarthTurret1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
