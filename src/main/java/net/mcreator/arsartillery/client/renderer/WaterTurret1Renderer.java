...
public class WaterTurret1Renderer extends GeoEntityRenderer<WaterTurret1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, WaterTurret1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
