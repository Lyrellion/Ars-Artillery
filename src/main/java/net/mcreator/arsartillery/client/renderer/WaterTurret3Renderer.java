...
public class WaterTurret3Renderer extends GeoEntityRenderer<WaterTurret3Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, WaterTurret3Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
