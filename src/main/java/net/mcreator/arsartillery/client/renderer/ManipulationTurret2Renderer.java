...
public class ManipulationTurret2Renderer extends GeoEntityRenderer<ManipulationTurret2Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ManipulationTurret2Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
