...
public class AirTurret1Renderer extends GeoEntityRenderer<AirTurret1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, AirTurret1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
