...
public class ConjurationTurret1Renderer extends GeoEntityRenderer<ConjurationTurret1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ConjurationTurret1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
