...
public class AirTurret3Renderer extends GeoEntityRenderer<AirTurret3Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, AirTurret3Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
