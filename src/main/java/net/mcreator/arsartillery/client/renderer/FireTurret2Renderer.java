...
public class FireTurret2Renderer extends GeoEntityRenderer<FireTurret2Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FireTurret2Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
